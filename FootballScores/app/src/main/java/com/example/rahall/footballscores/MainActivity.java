...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //if (!(config.getLayoutDirection() == View.LAYOUT_DIRECTION_RTL)) {
            tabLayout.addTab(tabLayout.newTab().setText(Utilities.getTabName(this, 0)));
            tabLayout.addTab(tabLayout.newTab().setText(Utilities.getTabName(this, 1)));
            tabLayout.addTab(tabLayout.newTab().setText(Utilities.getTabName(this, 2)));
            tabLayout.addTab(tabLayout.newTab().setText(Utilities.getTabName(this, 3)));
            tabLayout.addTab(tabLayout.newTab().setText(Utilities.getTabName(this, 4)));
        ...
        if(Utilities.isNetworkAvailable(this)) {
            ...
            Utilities.showAlertDialog(getString(R.string.network_error).toString(),this);
        }
    }
    @Override
