package com.example.rahall.footballscores.data;
...
public class DatabaseContract
{
    ...
    public static final class scores_table implements BaseColumns
    {
        ...
        public static final String HOME_TEAM_LOGO_URL = "home_team_logo_url";
        public static final String AWAY_TEAM_LOGO_URL = "away_team_logo_url";
    ...
    //URI data
    public static final String CONTENT_AUTHORITY = "com.example.rahall.footballscores";
